@echo off
::CONFIGURATION
SET REPO_URL=http://CA3EYGSWINAPP01.dev.local/svn/rrm
SET REPO_PATH=E:\csvn\data\repositories\rrm
SET DUMP_DIR=\\10.101.2.18\Files\csvn\data\Backup\RRM\Weekly
SET LAST_DELTA_FILE=C:\BackupScripts_SVN\RRM\DeltaFile\svn_backup_delta.txt
:END_CONFIGURATION
echo.
